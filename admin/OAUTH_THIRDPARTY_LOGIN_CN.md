...
| 平台 | 控制台 URL | 需要的 Credential |
|------|-----------|------------------|
| Google | [console.cloud.google.com](https://console.cloud.google.com) | OAuth 2.0 Client ID（Web application 类型） |
| Facebook | [developers.facebook.com](https://developers.facebook.com) | App ID + 添加 Facebook Login 产品 |
| Apple | [developer.apple.com](https://developer.apple.com) | Sign in with Apple 服务 + 私钥(.p8) |
