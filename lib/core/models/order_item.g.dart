...
OrderItem _$OrderItemFromJson(Map<String, dynamic> json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = OrderItem(
          ...
          discountAmount:
              $checkedConvert('discountAmount', (v) => v as String?),
          ...
          orderStatus:
              $checkedConvert('orderStatus', (v) => (v as num).toInt()),
          payStatus: $checkedConvert('payStatus', (v) => (v as num).toInt()),
          refundStatus:
              $checkedConvert('refundStatus', (v) => (v as num).toInt()),
          treasure: $checkedConvert(
              'treasure', (v) => Treasure.fromJson(v as Map<String, dynamic>)),
          ...
          addressResp: $checkedConvert(
              ...
              (v) => v == null
                  ? null
                  : AddressRes.fromJson(v as Map<String, dynamic>)),
          ...
          group: $checkedConvert(
              'group',
              (v) =>
                  v == null ? null : Group.fromJson(v as Map<String, dynamic>)),
          ...
          refundRejectReason:
              $checkedConvert('refundRejectReason', (v) => v as String?),
        );
        return val;
      },
    );
...
Treasure _$TreasureFromJson(Map<String, dynamic> json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = Treasure(
          ...
          seqShelvesQuantity:
              $checkedConvert('seqShelvesQuantity', (v) => v as num?),
...
Group _$GroupFromJson(Map<String, dynamic> json) => $checkedCreate(
      ...
      ($checkedConvert) {
        final val = Group(
          ...
          groupStatus:
              $checkedConvert('groupStatus', (v) => (v as num).toInt()),
          currentMembers:
    ...
    $checkedCreate(
      ...
      ($checkedConvert) {
        final val = RefundOrderResp(
          ...
          orderNo: $checkedConvert('orderNo', (v) => v as String),
          refundStatus:
              $checkedConvert('refundStatus', (v) => (v as num?)?.toInt() ?? 0),
